...
SCENARIO("Array should be sorted","[sorting]"){
    GIVEN("Unsorted array of int, and copy of for std::sort"){
        ...
        WHEN("Array is sorted by MergeSort"){
            MSort(input, 0 , input_vec.size()-1);
            THEN("Array sorted by MergeSort are equal to array sorted by std::sort"){
